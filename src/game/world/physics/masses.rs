pub const TREE_RADIUS: f32 = 0.48;
pub const TREE_GRIP_RAY_RADIUS: f32 = TREE_RADIUS + 0.2;

pub const PLAYER_MAX_LIFT_MASS: f32 = 28.0;
...
const TREE_BASE_MASS: f32 = 2.5;
const TREE_LOG_MASS: f32 = 1.8;
const TREE_MASS_CAP: f32 = 24.0;
